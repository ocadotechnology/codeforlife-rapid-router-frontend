...
const backgroundTileLayer = makeBackgroundTileLayer([
  ...
  [
    ...
    Tilesets.ROAD_TURN | Tilesets.Rotate[270], //house here
  ...
  [
    ...
    Tilesets.GRASS,
    Tilesets.ROAD_STRAIGHT, //house here
    Tilesets.GRASS,
  ...
  [
    ...
    Tilesets.GRASS,
    Tilesets.ROAD_TURN | Tilesets.Rotate[180],
    Tilesets.ROAD_T_JUNCTION, //house here
    Tilesets.GRASS,
    Tilesets.ROAD_STRAIGHT,
    Tilesets.GRASS,
    Tilesets.GRASS,
  ...
  [
    ...
    Tilesets.ROAD_STRAIGHT | Tilesets.Rotate[90],
    Tilesets.ROAD_STRAIGHT | Tilesets.Rotate[90],
    Tilesets.ROAD_STRAIGHT | Tilesets.Rotate[90], //house here
